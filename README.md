...
part 3
Does it make sense for an ALU result to set both the N and Z condition
code bits? Why or why not?
The V bit is set when the ALU result is the opposite sign of both of the
